...
const App: React.FC = () => {
  ...
  // Render a join screen if no user is set
  if (!currentUser) {
    return (
      <div className="flex flex-col h-screen bg-somnia-dark text-somnia-text font-sans antialiased items-center justify-center p-4">
